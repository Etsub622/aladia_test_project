<template>
  <div class="container mx-auto py-8" style="padding-left: 90px;" >
    ...
    <ul class="list-disc pl-6 space-y-2">
      ...
      <li>Anyone looking to develop their organisation into an environment that customers want to interact with and develop loyalty to</li>
      <li>Anyone with frontline customer service experience, leadership or management experience, whether in a junior to middle management level or those who wish to move into a middle/senior management role within a customer focussed organisation</li>
    ...
    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-6" @click="toggleShowMoreText">
